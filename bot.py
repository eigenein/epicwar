...
class Bot:
    ...
    def check_bastion(self):
        ...
        runes_expected, commands = BASTION_COMMANDS[bastion.fair_id]
        ...
        logging.info("Farmed %s of %s runes.", runes_farmed, runes_expected)
        self.audit_log.append("Farmed *{} of {} runes* in bastion *{}*.".format(
            runes_farmed, runes_expected, bastion.fair_id))
